    ...
    >
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <a
            ...
            onMouseEnter={(e) => {
              ...
              el.style.boxShadow = "0 4px 18px rgba(37,153,246,0.35)";
            }}
            onMouseLeave={(e) => {
              const el = e.currentTarget as HTMLElement;
        ...
        <button
          type="button"
          onClick={() => setOpen((v) => !v)}
          className="md:hidden relative z-[600] flex flex-col gap-[5px] p-1 bg-transparent border-none cursor-pointer"
      ...
      {/* Mobile overlay */}
      <div
        className="md:hidden fixed inset-0 z-[500] transition-all duration-300"
        style={{
